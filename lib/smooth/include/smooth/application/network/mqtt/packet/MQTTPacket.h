        ...
        namespace network
        {
            namespace mqtt
            {
                namespace packet
                {
                    ...
                    class MQTTPacket : public smooth::core::network::IPacketDisassembly
                    {
                        ...
                        public:
                            ...
                            bool is_too_big() const { return too_big; }

                            void set_dup_flag();
                            const char* get_mqtt_type_as_string() const;

                            int get_send_length() override { return static_cast<int>(data.size()); }

                            const uint8_t* get_data() override { return data.data(); }
