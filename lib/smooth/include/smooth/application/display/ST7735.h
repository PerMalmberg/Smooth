...
namespace smooth::application::display
{
    ...
    ************************************************************************************/
    ...
    static const cgram_offset_t offsets_green_tab_160x80 = { 26, 1 };
    static const cgram_offset_t offsets_green_tab_mini_160x80 = { 24, 0 };
    static const cgram_offset_t offsets_green_tab_128 = { 0, 32 };
    static const cgram_offset_t offsets_green_tab_1 = { 2, 1 };
    static const cgram_offset_t offsets_green_tab_2 = { 2, 3 };
    static const cgram_offset_t offsets_red_tab_160x80 = { 2, 3 };
}
