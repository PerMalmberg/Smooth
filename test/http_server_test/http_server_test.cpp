...
namespace http_server_test
{
    ...
    void App::init()
    {
        ...
        wifi.connect_to_ap();
#endif
        insecure_server = std::make_unique<HTTPServer<ServerSocket<Client, Protocol>>>(*this);
        ...
        secure_server = std::make_unique<HTTPServer<SecureServerSocket<Client, Protocol>>>(*this);
